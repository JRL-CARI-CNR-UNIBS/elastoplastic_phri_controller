...
#define USE_CARTESIAN_REFERENCE
  ...
  msg.cart_shared_twist = tf2::toMsg(m_computed_target_twist_shared_world_in_world);
  msg.cart_shared_acc = tf2::toMsg(m_computed_target_acc_shared_world_in_world);
